...
/**
 * Full-bleed dark "energetic gym" backdrop for the admin login screen — a
 * fixed neon dual-tone (orange + cyan) aesthetic, deliberately independent
 * of the app's light/dark theme toggle. Login-only: not imported anywhere
 * else, zero effect on any other route.
 */
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden bg-[#07070b]">
      ...
      <svg className="absolute inset-0 size-full opacity-[0.07]" aria-hidden>
        <pattern id="admin-login-grid" width="30" height="30" patternUnits="userSpaceOnUse">
