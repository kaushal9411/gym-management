...
/** Covers the entire viewport — for hard full-page transitions and the global loading overlay. Pair with `useDelayedLoading` at the call site to avoid a flash on fast loads. */
